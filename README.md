...
✔ Additional metrics to support strategic decisions.

# 1️⃣ Total Registrations by Visitor Type
- A bar chart was created to show the distribution of registrations across visitor categories.
...
- **Visitor Type vs. Country:** Crosstab analysis shows that Canada and Germany have notable participation, mostly as Buyers and Speakers.
...
2. Leverage returning attendees by offering loyalty incentives;
3. Target high-volume buyers with tailored exhibitor packages;
...
**Clone the repository:** https://github.com/rafaelasas/techtextil-case-study/
